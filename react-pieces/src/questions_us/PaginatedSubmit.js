...
export default function sendData() {
  ...
  const optIn = !!document.querySelectorAll("input[type='checkbox']:checked") || false;
  ...
  return fetch(url, {
    ...
    body: JSON.stringify({ textColl, optIn, slidersColl, reference, sessionId: randomInit.number }) // body data type must match "Content-Type" header
